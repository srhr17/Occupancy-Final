								...
								<MDBCol md="6">
									<MDBCard class="d-flex justify-content-center">
										...
										<MDBCardBody className="mx-4 mt-4">
											...
											<div>
												<Router>
													<NavLink to="/forgotpassword" exact onClick={this.forgotpassword}>
														Forgot password
													</NavLink>
												</Router>
											</div>
											...
											<p className="font-small grey-text d-flex justify-content-center">
												...
												<Router>
													<NavLink to="/" exact onClick={this.signup}>
														Sign up
													</NavLink>
												</Router>
											</p>
											<Router>
												<NavLink to="/display" exact onClick={this.display}>
													<MDBBtn color="purple" type="button" className="btn-block">
											...
											<br />
											<Router>
												<NavLink to="/viewcancel" exact onClick={this.viewcancelclass}>
													<MDBBtn color="purple" type="button" className="btn-block">
