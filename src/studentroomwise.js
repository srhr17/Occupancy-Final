  ...
  return(
    ...
    {/* <div className="container-login100" style={{backgroundImage: {flex: 1,resizeMode: 'stretch'},backgroundImage: 'url("https://edtechmagazine.com/higher/sites/edtechmagazine.com.higher/files/styles/cdw_hero/public/articles/hied-flipped.jpg?itok=0JGxMS-4")'}}> */}
      ...
      <div  style={{backgroundColor:"#ffeecc"}}>
        ...
        <form action="http://localhost:8000/roomwise" method="POST"  style={{border: '3px solid black', textAlign: 'center', padding: '15px', margin: '100px 450px', backgroundColor: 'ivory', borderRadius: '35px',marginTop:"14%"}}>
        ...
        <span style={{color: "red"}}>{this.state.errors["day"]}</span> <br/>
           ...
           <label><h3 style={{paddingLeft:'30px',paddingRight:'30px'}}>ROOM NUMBER:</h3></label>
   
   
         
   <select name="room" onChange={this.handleChange} style={{borderRadius:'10px',paddingRight:'10px',paddingLeft:'10px',width:'150px'}}>
     <option value=" ">Select</option>
...
<span style={{color: "red"}}>{this.state.errors["room"]}</span> <br/>
            ...
            <button style={{borderRadius: '50px', width: '150px',backgroundColor:' #80ff80'}} data-testid = "submitbutton" onClick="">ROOMWISE</button>
