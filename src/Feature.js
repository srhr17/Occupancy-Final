							...
							<fieldset>
								<form action="http://localhost:8000/Insert" method="POST">
									...
									<input
										...
										name="r2"
										placeholder="Room no *"
										onChange={this.handleChange2.bind(this, 'r2')}
									/>
									...
									<select
										id="lang"
										name="ac1"
										onChange={this.handleChange2.bind(this, 'ac1')}
										style={{
											borderRadius: '4px',
											width: '100%',
											backgroundColor: 'rgb(158, 151, 151)'
									...
									<select
										id="lang"
										name="proj1"
										onChange={this.handleChange2.bind(this, 'proj1')}
										style={{
											borderRadius: '4px',
											width: '100%',
											backgroundColor: 'rgb(158, 151, 151)'
									...
									<select
										id="lang"
										name="mb1"
										onChange={this.handleChange2.bind(this, 'mb1')}
										style={{
											borderRadius: '4px',
											width: '100%',
											backgroundColor: 'rgb(158, 151, 151)'
									...
									<select
										id="lang"
										name="skt1"
										onChange={this.handleChange2.bind(this, 'skt1')}
										style={{
											borderRadius: '4px',
											width: '100%',
											backgroundColor: 'rgb(158, 151, 151)'
									...
									<select
										id="lang"
										name="sb1"
										onChange={this.handleChange2.bind(this, 'sb1')}
										style={{
											borderRadius: '4px',
											width: '100%',
											backgroundColor: 'rgb(158, 151, 151)'
									...
									<select
										id="lang"
										name="mic1"
										onChange={this.handleChange2.bind(this, 'mic1')}
										style={{
											borderRadius: '4px',
											width: '100%',
											backgroundColor: 'rgb(158, 151, 151)'
							...
							<fieldset>
								<form action="http://localhost:8000/Modify" method="POST">
									...
									<input
										...
										name="r3"
										placeholder="Room no *"
										onChange={this.handleChange3.bind(this, 'r2')}
									/>
									...
									<select
										id="lang"
										name="ac2"
										onChange={this.handleChange3.bind(this, 'ac2')}
										style={{
											borderRadius: '4px',
											width: '100%',
											backgroundColor: 'rgb(158, 151, 151)'
									...
									<select
										id="lang"
										name="proj2"
										onChange={this.handleChange3.bind(this, 'proj2')}
										style={{
											borderRadius: '4px',
											width: '100%',
											backgroundColor: 'rgb(158, 151, 151)'
									...
									<select
										id="lang"
										name="mb2"
										onChange={this.handleChange3.bind(this, 'mb2')}
										style={{
											borderRadius: '4px',
											width: '100%',
											backgroundColor: 'rgb(158, 151, 151)'
									...
									<select
										id="lang"
										name="skt2"
										onChange={this.handleChange3.bind(this, 'skt2')}
										style={{
											borderRadius: '4px',
											width: '100%',
											backgroundColor: 'rgb(158, 151, 151)'
									...
									<select
										id="lang"
										name="sb2"
										onChange={this.handleChange3.bind(this, 'sb2')}
										style={{
											borderRadius: '4px',
											width: '100%',
											backgroundColor: 'rgb(158, 151, 151)'
									...
									<select
										id="lang"
										name="mic2"
										onChange={this.handleChange3.bind(this, 'mic2')}
										style={{
											borderRadius: '4px',
											width: '100%',
											backgroundColor: 'rgb(158, 151, 151)'
