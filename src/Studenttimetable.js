  ...
  return(
    ...
    <div  >
      <div style={{backgroundColor:"#ffeecc"}} > 
        ...
        <h1 style={{textAlign: 'center', border: '20px solid white', padding: '20px', backgroundColor: '#b3daff', borderBottom: '20px solid grey',paddingRight:"30px"}}>STUDENT TIMETABLE</h1>
        
        <form action="http://localhost:8000/time" method="POST"  style={{border: '3px solid black', textAlign: 'center', padding: '15px', margin: '10px 450px', backgroundColor: 'ivory', borderRadius: '35px',marginTop:"13%",}}>
