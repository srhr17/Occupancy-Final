            ...
            <form role="form" method="post" id="reused_form">
              ...
              <div className="row">
                <div className="col-sm-12 form-group">
                  ...
                  <textarea className="form-control" type="textarea" onChange={this.commentChange} name="comments" id="comments" placeholder="Your Comments" maxLength={6000} rows={7} defaultValue={""} />
                </div>
              </div>
              <div className="row">
                <div className="col-sm-6 form-group">
                  <label htmlFor="name"> Your Name:</label>
                  <input type="text" className="form-control" id="name" name="name"onChange={this.nameChange} required />
                </div>
                <div className="col-sm-6 form-group">
                  <label htmlFor="email"> Email:</label>
                  <input type="email" className="form-control" id="email" name="email" onChange={this.emailChange} required />
                </div>
              </div>
              <div className="row">
                <div className="col-sm-12 form-group">
                  <button type="submit" className="btn btn-lg btn-warning btn-block"onClick={this.submit}>Post </button>
                </div>
              </div>
            </form>
