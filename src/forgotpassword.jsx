						...
						<MDBCol md="6">
							<MDBCard>
								<MDBCardBody className="mx-4">
									...
									<MDBInput label="Your id" group type="text" name="id" validate />
									<MDBInput
									...
									<MDBInput
										...
										containerClass="mb-0"
									/>
									<div className="errors">{this.state.errors.new_password} </div>
										...
										<MDBBtn
											...
											onClick={(e) => {
												...
												if (
													...
													this.state.errors.password != this.state.errors.new_password
												) {
